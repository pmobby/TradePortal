...
namespace TradeApi.Models
{
    public class Customer
    {
        ...
        //public decimal FullPriceDeliveryCost { get; set; }
        //public decimal QualifiedDeliveryCost { get; set; }
        //public int OrderQualificationValue { get; set; }

        public ICollection<MessageNotification> Notifications { get; set; }
